...
void init(Handle<Object> exports) {
  ...
  exports->Set(String::NewSymbol("BorderGeometryDefault"), String::New(Magick::borderGeometryDefault), ReadOnly);
  exports->Set(String::NewSymbol("FrameGeometryDefault"), String::New(Magick::frameGeometryDefault), ReadOnly);
  exports->Set(String::NewSymbol("RaiseGeometryDefault"), String::New(Magick::raiseGeometryDefault), ReadOnly);
}
...
Handle<Value> Geometry::New(const Arguments& args) {
  ...
  that->Wrap(args.This());
  if (args.Length() != 1 || !(args[0]->IsObject() || args[0]->IsString()) || args[0]->IsFunction())
    return ThrowException(v8::Exception::TypeError(String::New("Invalid GeometryObject")));

  Magick::Geometry* aGeometry;
  if (args[0]->IsObject()) {
    Local<Object> aObj = args[0]->ToObject();
    Local<String> aKey;
    ...
    aGeometry = new Magick::Geometry(*String::Utf8Value(args[0]));
  }
